...
let panelKnowledge_1, panelKnowledge_2,
    valuesForTreeFirst = [16, 23, 41, 35, 89],
    valuesForTreeSecond = [1, 2, 4, 5, 6, 7, 8, 9, 10],
    BST_1, BST_2,
    nodeElements = [], nodeGroupElements = [], nodeGroupElementLocations = [],
    widthOfPanel = 350,
    heightOfPanel = 350,
    verticalSpacing = 65,
    radius = 25,
...
function drawOnPanel_1() {
    ...
    for (let index = 0; index < valuesForTreeFirst.length; index++) {
        ...
        let nodeElement = TreePanelController.createNewNodeElement(valuesForTreeFirst[index], BST_1);
        nodeElements[index] = nodeElement;
        let nodeGroupViewingElement = TreePanelController.createNewNodeGroupViewingElement(panelKnowledge_1, nodeElement, index, radius);
        nodeGroupElements[index] = nodeGroupViewingElement;

        let nodeGroupViewingElementVektor = TreePanelController.createNewNodeGroupViewingElementVektor(nodeElement, widthOfPanel, heightOfPanel, verticalSpacing, angle, 5, 1, 1, 1);
    ...
    for (let index = 0; index < nodeElements.length; index++) {
        ...
        if (element.left != null && element.right != null) {
            ...
            TreePanelController.drawArrow(panelKnowledge_1, element, leftTempNode, radius);
            TreePanelController.drawArrow(panelKnowledge_1, element, rightTempNode, radius);
        }
...
function drawOnPanel_2() {
    ...
    BST_2 = new BinarySearchTree();
    let allNodes = [], allNodeGroupElements = [], circles = [], labels = [];

    for (let index = 0; index < valuesForTreeSecond.length; index++) {
        allNodes.push(new Node(valuesForTreeSecond[index]));
        let nodeGroupViewingElement = TreePanelController.createNewNodeGroupViewingElement(panelKnowledge_2, allNodes[index], index, radius);
    ...
    allNodeGroupElements[2].setLocationXY(widthOfPanel_2 / drawingLevelX * 4, heightOfPanel_2 / drawingLevelY * 1);
    circles[2].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 4, heightOfPanel_2 / drawingLevelY * 1);
    labels[2].setLocationXY(widthOfPanel_2 / drawingLevelX * 4, heightOfPanel_2 / drawingLevelY * 1);
    panelKnowledge_2.addElement(circles[2]);
    panelKnowledge_2.addElement(labels[2]);

    allNodeGroupElements[0].setLocationXY(widthOfPanel_2 / drawingLevelX * 6, heightOfPanel_2 / drawingLevelY * 2);
    circles[0].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 6, heightOfPanel_2 / drawingLevelY * 2);
    labels[0].setLocationXY(widthOfPanel_2 / drawingLevelX * 6, heightOfPanel_2 / drawingLevelY * 2);
    panelKnowledge_2.addElement(circles[0]);
    panelKnowledge_2.addElement(labels[0]);

    allNodeGroupElements[5].setLocationXY(widthOfPanel_2 / drawingLevelX * 2, heightOfPanel_2 / drawingLevelY * 2);
    circles[5].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 2, heightOfPanel_2 / drawingLevelY * 2);
    labels[5].setLocationXY(widthOfPanel_2 / drawingLevelX * 2, heightOfPanel_2 / drawingLevelY * 2);
    panelKnowledge_2.addElement(circles[5]);
    panelKnowledge_2.addElement(labels[5]);

    allNodeGroupElements[4].setLocationXY(widthOfPanel_2 / drawingLevelX * 2, heightOfPanel_2 / drawingLevelY * 3.2);
    circles[4].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 2, heightOfPanel_2 / drawingLevelY * 3.2);
    labels[4].setLocationXY(widthOfPanel_2 / drawingLevelX * 2, heightOfPanel_2 / drawingLevelY * 3.2);
    panelKnowledge_2.addElement(circles[4]);
    panelKnowledge_2.addElement(labels[4]);

    allNodeGroupElements[6].setLocationXY(widthOfPanel_2 / drawingLevelX * 7, heightOfPanel_2 / drawingLevelY * 3.2);
    circles[6].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 7, heightOfPanel_2 / drawingLevelY * 3.2);
    labels[6].setLocationXY(widthOfPanel_2 / drawingLevelX * 7, heightOfPanel_2 / drawingLevelY * 3.2);
    panelKnowledge_2.addElement(circles[6]);
    panelKnowledge_2.addElement(labels[6]);

    allNodeGroupElements[8].setLocationXY(widthOfPanel_2 / drawingLevelX * 5, heightOfPanel_2 / drawingLevelY * 3.2);
    circles[8].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 5, heightOfPanel_2 / drawingLevelY * 3.2);
    labels[8].setLocationXY(widthOfPanel_2 / drawingLevelX * 5, heightOfPanel_2 / drawingLevelY * 3.2);
    panelKnowledge_2.addElement(circles[8]);
    panelKnowledge_2.addElement(labels[8]);

    allNodeGroupElements[3].setLocationXY(widthOfPanel_2 / drawingLevelX * 6, heightOfPanel_2 / drawingLevelY * 3.2);
    circles[3].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 6, heightOfPanel_2 / drawingLevelY * 3.2);
    labels[3].setLocationXY(widthOfPanel_2 / drawingLevelX * 6, heightOfPanel_2 / drawingLevelY * 3.2);
    panelKnowledge_2.addElement(circles[3]);
    panelKnowledge_2.addElement(labels[3]);

    allNodeGroupElements[1].setLocationXY(widthOfPanel_2 / drawingLevelX * 1, heightOfPanel_2 / drawingLevelY * 4);
    circles[1].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 1, heightOfPanel_2 / drawingLevelY * 4);
    labels[1].setLocationXY(widthOfPanel_2 / drawingLevelX * 1, heightOfPanel_2 / drawingLevelY * 4);
    panelKnowledge_2.addElement(circles[1]);
    panelKnowledge_2.addElement(labels[1]);

    allNodeGroupElements[7].setLocationXY(widthOfPanel_2 / drawingLevelX * 3, heightOfPanel_2 / drawingLevelY * 4);
    circles[7].setCenterLocationXY(widthOfPanel_2 / drawingLevelX * 3, heightOfPanel_2 / drawingLevelY * 4);
    labels[7].setLocationXY(widthOfPanel_2 / drawingLevelX * 3, heightOfPanel_2 / drawingLevelY * 4);
    panelKnowledge_2.addElement(circles[7]);
    panelKnowledge_2.addElement(labels[7]);

    TreePanelController.drawArrowForTernaryTree(panelKnowledge_2, allNodes, allNodeGroupElements, radius);
}
...
class QuestionsKnowledgeVisual extends Observable {
    ...
    constructor(el) {
        ...
        this.binarySearchTreeKnowl_2 = el.querySelector("#knowledge-2-binary-search-tree");
